...
import { BoxTemplateConfig } from "@/components/box-template-config"
import { StorageToggle } from "@/components/storage-toggle" // Add this import
        ...
        <TabsContent value="notifications" className="mt-6">
          <div className="max-w-3xl mx-auto">
            <section>
              ...
              <p className="text-muted-foreground mb-6">Configure how and where your data is stored</p>
